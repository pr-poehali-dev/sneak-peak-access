  ...
  return (
    <section ref={sectionRef} className="py-32 lg:py-40 px-6 lg:px-12 bg-sage">
      <div className="max-w-5xl mx-auto text-center">
        ...
        >
          Любовь — это не то, как долго вы вместе, а то, как тепло становится рядом друг с другом
          в самый обычный день. Мы благодарны судьбе за встречу и счастливы, что вы будете рядом.
        </blockquote>
        ...
        >
          <p className="text-sm tracking-widest uppercase text-primary-foreground/80">Анна &amp; Михаил</p>
          <p className="text-sm text-primary-foreground/60 mt-1">С любовью, будущие супруги</p>
        </div>
      </div>
    </section>
  )
